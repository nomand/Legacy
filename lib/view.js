function View()
{
  ...
  this.getTemplate = function(db)
  {
    ...
    let type = db[Object.keys(db)[0]].TYPE

    if(type !== 'undefined')
      this.grid.innerHTML = window[type + "Template"](dbKeys, type);
  ...
  this.stats = function(value)
  {
    ...
    {
      menuContent += `<div style="display:inline-block;">Tags (${value.tags.length}):`;
