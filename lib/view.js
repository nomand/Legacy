function View()
{
  ...
  this.stats = function(value)
  {
    ...
    // TYPE
    menuContent += `<a id="stat" class="round" href="#">${value.total} Home</div></a>`;
    ...
    if (value.tags.length > 0)
    {
      ...
      for (var t = 0; t < (SETTINGS.STATSNUMTAGS == 0 ? value.types.length : Math.min(value.types.length, SETTINGS.STATSNUMTAGS)); t++) 
      {
        menuContent += `
