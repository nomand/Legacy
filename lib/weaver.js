...
function showImage(entry)
{
    ...
    `<div id="lightbox" onClick="hideImage()">
        <div id="showcase">
            <div id="pict" style="background-image: url('content/images/${DB[entry].pict}.jpg');">
                <div id="post">
                    <a href="#${String(DB[entry].term).to_url()}" id="project">${DB[entry].term}</a> <a href="#${String(DB[entry].date).to_url()}" id="date">${DB[entry].date}</a><br/>
